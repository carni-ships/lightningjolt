...
// DoryVerifier7Circuit is a 7-round variant matching the muldiv test trace.
// Uses MiMC-hashed single public InputHash (same architecture as 11-round).
type DoryVerifier7Circuit struct {
	InputHash frontend.Variable `gnark:",public"`

	Alpha [NumRounds7]emulated.Element[sw_bn254.ScalarField]
	Beta  [NumRounds7]emulated.Element[sw_bn254.ScalarField]
	Gamma emulated.Element[sw_bn254.ScalarField]
	D     emulated.Element[sw_bn254.ScalarField]

	S1Coords [NumRounds7]emulated.Element[sw_bn254.ScalarField]
	S2Coords [NumRounds7]emulated.Element[sw_bn254.ScalarField]
	...
	D1Right [NumRounds7]fields_bn254.E12
	D2Right [NumRounds7]fields_bn254.E12
	...
	D2Scaled [NumRounds7]fields_bn254.E12
	D1Scaled [NumRounds7]fields_bn254.E12
	CPScaled [NumRounds7]fields_bn254.E12
	CMScaled [NumRounds7]fields_bn254.E12

	D1LScaled [NumRounds7]fields_bn254.E12
	D1LSSetup [NumRounds7]fields_bn254.E12
	D1RSSetup [NumRounds7]fields_bn254.E12

	D2LScaled [NumRounds7]fields_bn254.E12
	D2LSSetup [NumRounds7]fields_bn254.E12
	D2RSSetup [NumRounds7]fields_bn254.E12
	...
	CheckpointC  [NumRounds7]fields_bn254.E12
	CheckpointD1 [NumRounds7]fields_bn254.E12
	CheckpointD2 [NumRounds7]fields_bn254.E12

	SetupChi  [NumRounds7 + 1]fields_bn254.E12
...
func (c *DoryVerifier7Circuit) Define(api frontend.API) error {
	...
	for round := NumRounds7; round >= 1; round-- {
		idx := NumRounds7 - round
		a := &c.Alpha[idx]
